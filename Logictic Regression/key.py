Đã dùng 81% bộ nhớ … Bạn có thể giải phóng bộ nhớ hoặc mua thêm bộ nhớ cho Drive, Gmail và Google Photos.
import numpy as np
import pandas as pd
...
if (decisionBoundary(temp)==1) :
    ...
    print("Predict value is {}. So this student will fail!!".format(decisionBoundary(temp)))
